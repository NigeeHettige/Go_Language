...
// (s *APIServer) → Method Receiver

// s is a receiver variable.
// *APIServer means that s is a pointer to an APIServer struct.
// This allows handleAccount to modify the APIServer instance.
// handleAccount(w http.ResponseWriter, r *http.Request) error

// This function handles an HTTP request (r *http.Request) and writes a response (w http.ResponseWriter).
// It returns an error.
...
func (s *APIServer) handleCreateAccount(w http.ResponseWriter, r *http.Request) error {
	...
	// We add that because we did not plan login in first steps
	// tokenString, err := createJWT(account)
	// if err != nil {
	// 	return err
	// }
	// fmt.Print("JWT token:", tokenString)
...
func (s *APIServer) handleTransfer(w http.ResponseWriter, r *http.Request) error {
	transferReq := new(TransfeRequest)
